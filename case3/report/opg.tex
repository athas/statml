...
\let\fref\undefined \let\Fref\undefined 
\usepackage{fancyref} 

% Better reference. 
\usepackage{pdflscape} 

% Gør landscape-environmentet tilgængeligt
\usepackage{fixme} 

% Indsæt "fixme" noter i drafts.
\usepackage{hyperref} 

% Indsæter links (interne og eksterne) i PDF
...
% Sæt overskriftsnummereringsdybde. Disable = -1.
...
\maketitle \input{question11} \input{question12} \input{question21} \input{question22}
